      ...
      <div class="row">
        <div class="ten wide column">
          ...
          <ul class="ui list">
            ...
            <li><p>1 ทีมมีสมาชิก 3 คน และทั้ง 3 คนต้องมาจากโรงเรียนเดียวกัน</p></li>
  ...
  <div class="ui vertical stripe segment" style="background: #fff;">
    ...
    <div class="ui middle aligned stackable grid container">
      <div class="row">
        <div class="ten wide column">
          <ul class="ui list">
            <li><p>ชนะเลิศ: 5,000 บาท/ทีม พร้อมเกียรติบัตรสำหรับสมาชิกทุกคนในทีม</p></li>
            <li><p>รองชนะเลิศลำดับที่ 1: 3,000 บาท/ทีม พร้อมเกียรติบัตรสำหรับสมาชิกทุกคนในทีม</p></li>
            <li><p>รองชนะเลิศลำดับที่ 2: 2,000 บาท/ทีม พร้อมเกียรติบัตรสำหรับสมาชิกทุกคนในทีม</p></li>
