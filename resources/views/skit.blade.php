...
<head>
  ...
  และการแข่งขันต่าง ๆ ที่มีเงินรางวัลมูลค่ารวมกว่า 26,000 บาท พร้อมทั้งของรางวัลสุดพิเศษมากมายสำหรับทุกคน">
    ...
    <!-- Site Properties -->
    <title>Suankularb Computer Week 2016 : SKIC</title>
...
<body>
    ...
    <div class="pusher">
        <div class="ui inverted vertical masthead center aligned segment items">
            ...
            <div class="ui text container slideInUp animated">
                ...
                <h1 class="ui inverted header slideInUp animated blue">Suankularb Information and technology <br />Contest 2016</h1>
                <h2>การแข่งขันตอบปัญหาวิชาการทางด้านคอมพิวเตอร์ <br />และเทคโนโลยีสารสนเทศ ระดับมัธยมศึกษา <br />โรงเรียนสวนกุหลาบวิทยาลัย 2016</h2>
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam sed rhoncus neque. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Maecenas sed ultricies velit.
                </p>
            </div>
        ...
        <div class="ui vertical stripe segment">
            <h2 class="ui header centered blue" style="font-size: 2.5em;">กติกาและข้อกำหนดของการแข่งขัน</h2>
            <br />
            <div class="ui middle aligned stackable grid container">
                <div class="row">
                    <div class="ten wide column">
                        ...
                        <ul class="ui list">
                            <li>
                                <p>เป็นนักเรียนที่กำลังศึกษาอยู่ในระดับชั้นมัธยมศึกษาปีที่ 1-6</p>
                            </li>
                            <li>
                                <p>1 ทีมมีสมาชิก 3 คน และทั้ง 3 คนต้องมาจากโรงเรียนเดียวกัน</p>
                            </li>
                            <li>
                                <p>แต่ละโรงเรียนสามารถส่งทีมเข้าร่วมการแข่งขันได้ไม่เกินโรงเรียนละ 3 ทีม</p>
                            </li>
                            <li>
                                <p>แต่ละทีมต้องมีอาจารย์ที่ปรึกษาทีม 1 คนที่อยู่โรงเรียนเดียวกับผู้เข้าแข่งขัน</p>
                            </li>
                            <li>
                                <p>หากเป็นโรงเรียนเดียวกันแต่คนละทีม สามารถใช้อาจารย์ที่ปรึกษาทีมคนเดียวกันได้</p>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="ui vertical stripe segment inverted">
            <h2 class="ui header centered blue" style="font-size: 2.5em;">รูปแบบการแข่งขัน</h2>
            <br />
            <div class="ui middle aligned stackable grid container inverted">
                <div class="row">
                    <div class="eight wide column">
                        <h3 class="ui header inverted">รอบคัดเลือก</h3>
                        <ul class="ui list inverted">
                            <li>
                                <p>ข้อสอบจำนวนทั้งสิ้น 100 ข้อ ในระยะเวลา 2 ชั่วโมง</p>
                            </li>
                            <li>
                    ...
                    <div class="eight wide column">
                        <h3 class="ui header inverted">รอบชิงชนะเลิศ</h3>
                        <ul class="ui list inverted">
                            <li>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            </li>
    ...
    <div class="ui vertical stripe segment" style="background: #fff;">
        <h2 class="ui header centered blue" style="font-size: 2.5em;">รางวัล</h2>
        <br />
        <div class="ui middle aligned stackable grid container">
            <div class="row">
                <div class="ten wide column">
                    <ul class="ui list">
                        <li>
                            <p>ชนะเลิศ: 5,000 บาท/ทีม พร้อมเกียรติบัตรสำหรับสมาชิกทุกคนในทีม</p>
                        </li>
                        <li>
                            <p>รองชนะเลิศลำดับที่ 1: 3,000 บาท/ทีม พร้อมเกียรติบัตรสำหรับสมาชิกทุกคนในทีม</p>
                        </li>
                        <li>
                            <p>รองชนะเลิศลำดับที่ 2: 2,000 บาท/ทีม พร้อมเกียรติบัตรสำหรับสมาชิกทุกคนในทีม</p>
                        </li>
                        <li>
                            <p>ผู้เข้าร่วมการแข่งขัน: เกียรติบัตรสำหรับผู้เข้าร่วมการแข่งขันทุกคน</p>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="ui vertical stripe segment inverted">
        <h2 class="ui header centered blue" style="font-size: 2.5em;">สถานที่จัดการแข่งขัน</h2>
        <br />
        <div class="ui middle aligned stackable grid container">
            <div class="row">
                <div class="twenty wide column">
                    <p>
                        อาคารสวนกุหลาบรำลึก (อาคาร 6) ชั้น 3 โรงเรียนสวนกุหลาบวิทยาลัย 88 ถนนตรีเพชร แขวงวังบูรพาภิรมย์ เขตพระนคร กรุงเทพมหานคร 10200
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="ui vertical stripe segment" style="background: #fff;">
        <h2 class="ui header centered blue" style="font-size: 2.5em;">กำหนดการ</h2>
        <br />
        <div class="ui middle aligned stackable grid container">
            <div class="row">
                <div class="twelve wide column centered">
                    <table class="ui large blue selectable celled table">
                        <thead>
                            <tr>
                                <th>เวลา</th>
                                <th>กิจกรรม</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>2 ธันวาคม 2559</td>
                                <td>Suankularb Information and technology Contest 2016</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="ui inverted basic fluid segment div centered">
        ...
        <div class="ui fluid container center aligned">
            <a href="{{route('skit-register')}}"><button class="ui huge inverted button"><p>สมัครเข้าร่วมการแข่งขัน</p></button></a>
        </div>
    </div>
